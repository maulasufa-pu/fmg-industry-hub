...
describe("safe redirect handling", () => {
  test.each(["https://evil.example", "//evil.example", "javascript:alert(1)", ""])("rejects external or invalid target %s", (value) => expect(safeInternalPath(value)).toBe("/client/dashboard"));

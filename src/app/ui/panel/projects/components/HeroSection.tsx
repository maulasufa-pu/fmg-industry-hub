    ...
    <>
      ...
      >
        <motion.div
          ...
          style={{ backgroundImage: "radial-gradient(circle, rgba(255,255,255,0.32) 0%, transparent 55%)", backgroundSize: "45% 75%", backgroundRepeat: "no-repeat" }}
          animate={{
            backgroundPosition: ["0% 50%", "100% 50%", "50% 0%", "50% 100%", "0% 50%"],
          }}

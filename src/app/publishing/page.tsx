...
/*************************************************
 * FMG Universe — /publishing
 * Music Rights Management • Sync Licensing • Catalog Reissues • Publishing Administration
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 top-0 z-[60] flex h-14 items-center justify-between px-4 sm:px-8">
      <div className="pointer-events-auto inline-flex items-center gap-2 rounded-full bg-black/40 px-3 py-1.5 text-white backdrop-blur-md dark:bg-white/10">
        ...
        <span className="text-xs tracking-wide opacity-90">Universe • Publishing</span>
      </div>
...
/* ---------- Page ---------- */
export default function PublishingPage(): React.JSX.Element {
  ...
  const slides = useMemo(
    () => [
      {
        title: "FMG Publishing",
        kicker: "Rights • Sync • Catalog • Admin",
        description:
          "Full‑stack music publishing for modern creators — rights management, sync licensing, catalog reissues, and transparent administration.",
        headIcon: Music2,
        tint: "indigo" as const,
        artDepth: 0.85,
        cta: (
          <>
            <a href="#slide-1" className="inline-flex items-center justify-center rounded-xl bg-white px-4 py-2 text-sm font-semibold text-neutral-900 shadow hover:bg-neutral-100">Explore services</a>
            <a href="/publishing/inquiry" className="inline-flex items-center justify-center rounded-xl border border-white/40 px-4 py-2 text-sm font-semibold text-white hover:bg-white/10">Rights inquiry</a>
          </>
        ),
      },
      {
        title: "Rights Management",
        kicker: "Works • Splits • Registrations",
        description:
          "We safeguard your compositions and recordings with precise metadata, clean splits, and global registrations.",
        bullets: [
          "Work registration across PROs/CMOs & MLC",
          "Split sheets, writer IPI/CAE, and contributor credits",
          "ISWC/ISRC mapping, CWR delivery & conflict resolution",
          "Royalty audit trails and black box recovery",
        ] as const,
      ...
      },
      {
        ...
        kicker: "Film • TV • Ads • Games",
        description:
          "Creative pitching with fast, fair, and clear licensing — one‑stop options whenever possible.",
        bullets: [
          "Pre‑cleared catalog & one‑stop tracks",
          "Brief response & bespoke searches",
          "Quotes, terms & MFN‑aware negotiations",
          "Cue sheets, usage tracking & renewals",
        ] as const,
      ...
      {
        title: "Catalog Reissues",
        kicker: "Restore • Remaster • Redistribute",
        description:
          "Breathe new life into legacy masters with restoration, metadata enrichment, and platform‑native rollouts.",
        bullets: [
          "Chain‑of‑title verification & rights audit",
          "Restoration/remaster (wow/flutter, noise, loudness)",
          "Metadata cleanup, UPC/ISRC strategy & territories",
          "Reissues across DSPs + physical (on request)",
        ] as const,
        headIcon: Archive,
        tint: "amber" as const,
        artDepth: 1.0,
      },
      {
        ...
        kicker: "Statements • Claims • Reporting",
        description:
          "Transparent, timely administration so writers can focus on writing.",
        bullets: [
          "Global registrations & claims maintenance",
          "Royalty ingestion, matching & dispute handling",
          "Writer portal: monthly statements & advances",
          "Neighboring rights & sub‑pub options",
        ] as const,
        headIcon: ScrollText,
        tint: "indigo" as const,
        artDepth: 0.95,
        cta: (
          <a href="/publishing/proposal" className="inline-flex items-center justify-center rounded-xl bg-white px-4 py-2 text-sm font-semibold text-neutral-900 shadow hover:bg-neutral-100">Request proposal</a>
        ),
      },
    ],
    []
      ...
      >
        ...
        <section ref={registerRef(slides.length)} className="relative grid min-h-screen snap-start place-items-center px-4 py-20 sm:py-24 sm:px-8">
          ...
          <motion.div initial={{ opacity: 0, y: 14 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.5 }} transition={{ duration: 0.5 }} className="mx-auto max-w-3xl text-center">
            <h2 className="text-3xl font-semibold sm:text-4xl md:text-5xl">Partner with FMG Publishing.</h2>
            <p className="mx-auto mt-3 max-w-xl text-white/80">Secure your rights, unlock sync opportunities, and keep statements crystal clear.</p>
            <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
              <a href="/publishing/inquiry" className="inline-flex items-center justify-center rounded-xl bg-white px-5 py-2.5 text-sm font-semibold text-neutral-900 shadow hover:bg-neutral-100">Start a rights inquiry</a>
              <a href="/catalog" className="inline-flex items-center justify-center rounded-xl border border-white/40 px-5 py-2.5 text-sm font-semibold text-white hover:bg-white/10">View catalog</a>
            </div>
          </motion.div>
        </section>
      </div>

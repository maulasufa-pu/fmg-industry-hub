...
/*************************************************
 * FMG Universe — /events
 * Live shows • Showcases • Tour operations • Brand activations (measurable impact)
    ...
    () => [
      {
        ...
        cta: (
          <>
            ...
            <a href="/events/inquiry" className="inline-flex items-center justify-center rounded-xl border border-white/40 px-4 py-2 text-sm font-semibold text-white hover:bg-white/10">Start a brief</a>
          </>
        ),
      },
      {
      ...
      >
        ...
        <section ref={registerRef(slides.length)} className="relative grid min-h-screen snap-start place-items-center px-4 py-20 sm:py-24 sm:px-8">
          ...
          <motion.div initial={{ opacity: 0, y: 14 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.5 }} transition={{ duration: 0.5 }} className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-3 max-w-xl text-white/80">From club shows to festival stages — design, ops, and measurable impact in one team.</p>
            <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
              <a href="/events/inquiry" className="inline-flex items-center justify-center rounded-xl bg-white px-5 py-2.5 text-sm font-semibold text-neutral-900 shadow hover:bg-neutral-100">Start a brief</a>
              <a href="/events/deck" className="inline-flex items-center justify-center rounded-xl border border-white/40 px-5 py-2.5 text-sm font-semibold text-white hover:bg-white/10">Download event deck</a>
            </div>
          </motion.div>
        </section>
      </div>

...
export type AdminTabKey = "All" | "Active" | "Finished" | "Pending" | "Unassigned" | "Requested";
...
const headers: Array<{ key: keyof AdminProjectRow | "client" | "song" | "album" | "assignments"; label: string; sortable?: boolean }> = [
...
export default function AdminPanel({
  ...
  const checkScrollPosition = () => {
    if (listRef.current) {
      ...
      // Right arrow shows when we can scroll right (not at max scroll)  
  ...
  const tabs: AdminTabKey[] = ["All", "Active", "Finished", "Pending", "Unassigned", "Requested"];
    ...
    >
      ...
      >
        ...
        <div className="relative">
          {/* Left Arrow - Shows when NOT at beginning (can scroll left) */}
          <AnimatePresence>
            {canScrollLeft && (
              <motion.button
          ...
          {/* Right Arrow - Shows when NOT at end (can scroll right) */}
          <AnimatePresence>
            {canScrollRight && (
              <motion.button
      ...
      >
        {loading ? (
          <motion.div
            className="p-12 text-center text-gray-500 dark:text-gray-400 dark:text-gray-400"
                ...
                return (
                  <React.Fragment key={r.project_id}>
                    ...
                    >
                      ...
                      {/* Enhanced Expanded Row Animation */}
                      {isExpanded && (
                        <motion.tr 
                        ...
                        >
                          <td colSpan={8} className="p-0" style={{ overflow: 'hidden' }}>
                            <motion.div 
                            ...
                            >
                              <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 lg:gap-6">
                                  ...
                                  {/* Enhanced Team Assignments Sidebar */}
      ...
      >
        ...
        >
          ...
          >
            ...
            <span className="tabular-nums font-bold text-sky-600 dark:text-sky-200">{totalPages}</span>
          </motion.span>

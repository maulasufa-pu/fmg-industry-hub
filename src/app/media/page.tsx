  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 top-0 z-[60] flex h-14 items-center justify-between px-4 sm:px-8">
      <div className="pointer-events-auto inline-flex items-center gap-2 rounded-full bg-black/40 px-3 py-1.5 text-white backdrop-blur-md dark:bg-white/10">
        ...
        <span className="text-xs tracking-wide opacity-90">Universe • Media</span>
      </div>
...
export default function MediaPage(): React.JSX.Element {
  ...
  const slides = useMemo(
    () => [
      {
        title: "FMG Media",
        kicker: "Content • PR • Podcasts • Partners • Distribution",
        description:
          "Media engine for artists and brands — we craft content, grow audiences, build press narratives, and ship across every channel.",
        headIcon: Megaphone,
        ...
        cta: (
          <>
            ...
            <a href="/media/inquiry" className="inline-flex items-center justify-center rounded-xl border border-white/40 px-4 py-2 text-sm font-semibold text-white hover:bg-white/10">Start a brief</a>
          </>
        ),
      },
      {
        title: "Digital Content",
        kicker: "Stories • Video • Creative Ops",
        description:
          "We produce thumb‑stopping content systems: strategy, scripting, shoots, edits, and calendars that compound reach.",
        bullets: [
          "Content strategy & pillars per audience",
          "Short/long‑form video, reels, carousels",
          "Shoot logistics, crews, and post pipeline",
          "Editorial calendars & asset libraries",
        ] as const,
      ...
      },
      {
        ...
        kicker: "Narrative • Outreach • Earned Media",
        description:
          "Narratives that travel: social playbooks, press kits, and targeted outreach to the right editors & creators.",
        bullets: [
          "Brand voice & social playbooks",
          "Press kits, releases, and media lists",
          "Outreach & relationship management",
          "Crisis comms & measurement",
        ] as const,
        headIcon: Megaphone,
      ...
      {
        title: "Podcast & New Media",
        kicker: "Concept • Production • Distribution",
        description:
          "From show bible to syndication — we develop formats, record, edit, and distribute to every platform.",
        bullets: [
          "Concept & pilot development",
          "Remote/IRL recording & post‑production",
          "Show notes, clips & audiograms",
          "Sponsorships & growth loops",
        ] as const,
        headIcon: Radio,
        tint: "amber" as const,
        artDepth: 1.0,
      ...
      {
        title: "Media Partner & News",
        kicker: "Partnerships • Features • Coverage",
        description:
          "We broker win‑win media partnerships, coordinate features, and keep newsrooms in the loop.",
        bullets: [
          "Partner mapping & value exchange",
          "Feature coordination & embargo handling",
          "Brief responses for editors & producers",
      ...
      },
      {
        ...
        kicker: "DSPs • Platforms • Analytics",
        description:
          "Deliver assets cleanly with metadata that wins algorithms — and monitor what matters to act fast.",
        bullets: [
          "Release ops: metadata, UPC/ISRC, assets",
          "Platform‑native specs & QC",
          "Pre‑saves, canvases & link hubs",
          "Analytics dashboards & alerts",
        ] as const,
        headIcon: UploadCloud,
        tint: "violet" as const,
        artDepth: 1.05,
      },
    ],
      ...
      >
        ...
        <section ref={registerRef(slides.length)} className="relative grid min-h-screen snap-start place-items-center px-4 py-20 sm:py-24 sm:px-8">
          ...
          <motion.div initial={{ opacity: 0, y: 14 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.5 }} transition={{ duration: 0.5 }} className="mx-auto max-w-3xl text-center">
            <h2 className="text-3xl font-semibold sm:text-4xl md:text-5xl">Partner with FMG Media.</h2>
            <p className="mx-auto mt-3 max-w-xl text-white/80">Ship content, build narrative, and distribute with precision across every channel.</p>
            <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
              <a href="/media/inquiry" className="inline-flex items-center justify-center rounded-xl bg-white px-5 py-2.5 text-sm font-semibold text-neutral-900 shadow hover:bg-neutral-100">Start a brief</a>
              <a href="/press" className="inline-flex items-center justify-center rounded-xl border border-white/40 px-5 py-2.5 text-sm font-semibold text-white hover:bg-white/10">Press & media kit</a>
            </div>
          </motion.div>
        </section>
      </div>
